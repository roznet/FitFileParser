...
# If name appears here, will be marked as public
swift_public_func = {
    'rzfit_mesg_num_string' : 1,
}
...
class TypeDef :
    ...
    def swift_switch_function(self):
        if self.elements:
            func_name = self.swift_switch_function_name()
            if func_name in swift_public_func:
                prefix = 'public '
            else:
                prefix = ''

            rv = [ '// Auto-generated by swift_switch_function_name({})'.format( self.fit_type_name ) ]
            rv += [ '{}func {}(input : {}) -> String? '.format( prefix, self.swift_switch_function_name(), self.ctype ),
                   '{',
                   '  switch  input {' ]
    ...
    def swift_string_to_mesg(self,context):
        rv = ['// Auto-generated by swift_string_to_mesg()',
