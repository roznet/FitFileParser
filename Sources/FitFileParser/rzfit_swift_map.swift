...
public let FIT_MESG_NUM_FILE_ID : FIT_MESG_NUM = 0
public let FIT_MESG_NUM_CAPABILITIES : FIT_MESG_NUM = 1
public let FIT_MESG_NUM_DEVICE_SETTINGS : FIT_MESG_NUM = 2
public let FIT_MESG_NUM_USER_PROFILE : FIT_MESG_NUM = 3
public let FIT_MESG_NUM_HRM_PROFILE : FIT_MESG_NUM = 4
public let FIT_MESG_NUM_SDM_PROFILE : FIT_MESG_NUM = 5
public let FIT_MESG_NUM_BIKE_PROFILE : FIT_MESG_NUM = 6
public let FIT_MESG_NUM_ZONES_TARGET : FIT_MESG_NUM = 7
public let FIT_MESG_NUM_HR_ZONE : FIT_MESG_NUM = 8
public let FIT_MESG_NUM_POWER_ZONE : FIT_MESG_NUM = 9
public let FIT_MESG_NUM_MET_ZONE : FIT_MESG_NUM = 10
public let FIT_MESG_NUM_SPORT : FIT_MESG_NUM = 12
public let FIT_MESG_NUM_GOAL : FIT_MESG_NUM = 15
public let FIT_MESG_NUM_SESSION : FIT_MESG_NUM = 18
public let FIT_MESG_NUM_LAP : FIT_MESG_NUM = 19
public let FIT_MESG_NUM_RECORD : FIT_MESG_NUM = 20
public let FIT_MESG_NUM_EVENT : FIT_MESG_NUM = 21
public let FIT_MESG_NUM_DEVICE_INFO : FIT_MESG_NUM = 23
public let FIT_MESG_NUM_WORKOUT : FIT_MESG_NUM = 26
public let FIT_MESG_NUM_WORKOUT_STEP : FIT_MESG_NUM = 27
public let FIT_MESG_NUM_SCHEDULE : FIT_MESG_NUM = 28
public let FIT_MESG_NUM_WEIGHT_SCALE : FIT_MESG_NUM = 30
public let FIT_MESG_NUM_COURSE : FIT_MESG_NUM = 31
public let FIT_MESG_NUM_COURSE_POINT : FIT_MESG_NUM = 32
public let FIT_MESG_NUM_TOTALS : FIT_MESG_NUM = 33
public let FIT_MESG_NUM_ACTIVITY : FIT_MESG_NUM = 34
public let FIT_MESG_NUM_SOFTWARE : FIT_MESG_NUM = 35
public let FIT_MESG_NUM_FILE_CAPABILITIES : FIT_MESG_NUM = 37
public let FIT_MESG_NUM_MESG_CAPABILITIES : FIT_MESG_NUM = 38
public let FIT_MESG_NUM_FIELD_CAPABILITIES : FIT_MESG_NUM = 39
public let FIT_MESG_NUM_FILE_CREATOR : FIT_MESG_NUM = 49
public let FIT_MESG_NUM_BLOOD_PRESSURE : FIT_MESG_NUM = 51
public let FIT_MESG_NUM_SPEED_ZONE : FIT_MESG_NUM = 53
public let FIT_MESG_NUM_MONITORING : FIT_MESG_NUM = 55
public let FIT_MESG_NUM_TRAINING_FILE : FIT_MESG_NUM = 72
public let FIT_MESG_NUM_HRV : FIT_MESG_NUM = 78
public let FIT_MESG_NUM_ANT_RX : FIT_MESG_NUM = 80
public let FIT_MESG_NUM_ANT_TX : FIT_MESG_NUM = 81
public let FIT_MESG_NUM_ANT_CHANNEL_ID : FIT_MESG_NUM = 82
public let FIT_MESG_NUM_LENGTH : FIT_MESG_NUM = 101
public let FIT_MESG_NUM_MONITORING_INFO : FIT_MESG_NUM = 103
public let FIT_MESG_NUM_PAD : FIT_MESG_NUM = 105
public let FIT_MESG_NUM_SLAVE_DEVICE : FIT_MESG_NUM = 106
public let FIT_MESG_NUM_CONNECTIVITY : FIT_MESG_NUM = 127
public let FIT_MESG_NUM_WEATHER_CONDITIONS : FIT_MESG_NUM = 128
public let FIT_MESG_NUM_WEATHER_ALERT : FIT_MESG_NUM = 129
public let FIT_MESG_NUM_CADENCE_ZONE : FIT_MESG_NUM = 131
public let FIT_MESG_NUM_HR : FIT_MESG_NUM = 132
public let FIT_MESG_NUM_SEGMENT_LAP : FIT_MESG_NUM = 142
public let FIT_MESG_NUM_MEMO_GLOB : FIT_MESG_NUM = 145
public let FIT_MESG_NUM_SEGMENT_ID : FIT_MESG_NUM = 148
public let FIT_MESG_NUM_SEGMENT_LEADERBOARD_ENTRY : FIT_MESG_NUM = 149
public let FIT_MESG_NUM_SEGMENT_POINT : FIT_MESG_NUM = 150
public let FIT_MESG_NUM_SEGMENT_FILE : FIT_MESG_NUM = 151
public let FIT_MESG_NUM_WORKOUT_SESSION : FIT_MESG_NUM = 158
public let FIT_MESG_NUM_WATCHFACE_SETTINGS : FIT_MESG_NUM = 159
public let FIT_MESG_NUM_GPS_METADATA : FIT_MESG_NUM = 160
public let FIT_MESG_NUM_CAMERA_EVENT : FIT_MESG_NUM = 161
public let FIT_MESG_NUM_TIMESTAMP_CORRELATION : FIT_MESG_NUM = 162
public let FIT_MESG_NUM_GYROSCOPE_DATA : FIT_MESG_NUM = 164
public let FIT_MESG_NUM_ACCELEROMETER_DATA : FIT_MESG_NUM = 165
public let FIT_MESG_NUM_THREE_D_SENSOR_CALIBRATION : FIT_MESG_NUM = 167
public let FIT_MESG_NUM_VIDEO_FRAME : FIT_MESG_NUM = 169
public let FIT_MESG_NUM_OBDII_DATA : FIT_MESG_NUM = 174
public let FIT_MESG_NUM_NMEA_SENTENCE : FIT_MESG_NUM = 177
public let FIT_MESG_NUM_AVIATION_ATTITUDE : FIT_MESG_NUM = 178
public let FIT_MESG_NUM_VIDEO : FIT_MESG_NUM = 184
public let FIT_MESG_NUM_VIDEO_TITLE : FIT_MESG_NUM = 185
public let FIT_MESG_NUM_VIDEO_DESCRIPTION : FIT_MESG_NUM = 186
public let FIT_MESG_NUM_VIDEO_CLIP : FIT_MESG_NUM = 187
public let FIT_MESG_NUM_OHR_SETTINGS : FIT_MESG_NUM = 188
public let FIT_MESG_NUM_EXD_SCREEN_CONFIGURATION : FIT_MESG_NUM = 200
public let FIT_MESG_NUM_EXD_DATA_FIELD_CONFIGURATION : FIT_MESG_NUM = 201
public let FIT_MESG_NUM_EXD_DATA_CONCEPT_CONFIGURATION : FIT_MESG_NUM = 202
public let FIT_MESG_NUM_FIELD_DESCRIPTION : FIT_MESG_NUM = 206
public let FIT_MESG_NUM_DEVELOPER_DATA_ID : FIT_MESG_NUM = 207
public let FIT_MESG_NUM_MAGNETOMETER_DATA : FIT_MESG_NUM = 208
public let FIT_MESG_NUM_BAROMETER_DATA : FIT_MESG_NUM = 209
public let FIT_MESG_NUM_ONE_D_SENSOR_CALIBRATION : FIT_MESG_NUM = 210
public let FIT_MESG_NUM_SET : FIT_MESG_NUM = 225
public let FIT_MESG_NUM_STRESS_LEVEL : FIT_MESG_NUM = 227
public let FIT_MESG_NUM_DIVE_SETTINGS : FIT_MESG_NUM = 258
public let FIT_MESG_NUM_DIVE_GAS : FIT_MESG_NUM = 259
public let FIT_MESG_NUM_DIVE_ALARM : FIT_MESG_NUM = 262
public let FIT_MESG_NUM_EXERCISE_TITLE : FIT_MESG_NUM = 264
public let FIT_MESG_NUM_DIVE_SUMMARY : FIT_MESG_NUM = 268
public let FIT_MESG_NUM_JUMP : FIT_MESG_NUM = 285
public let FIT_MESG_NUM_CLIMB_PRO : FIT_MESG_NUM = 317
public let FIT_MESG_NUM_MFG_RANGE_MIN : FIT_MESG_NUM = 0xFF00
public let FIT_MESG_NUM_MFG_RANGE_MAX : FIT_MESG_NUM = 0xFFFE


//MARK: - convertion functions

public func rzfit_swift_mesg_num_to_name(mesg_num : FIT_UINT16) -> String?
{
   switch mesg_num {
...
public func rzfit_swift_name_to_mesg_num(name : String) -> FIT_UINT16
{
   switch name {
